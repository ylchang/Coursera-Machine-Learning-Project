...
The following R code chuck produce the predictions for the 20 test cases by using the model created above. The test case data, **testNum** have been cleaned up in the **Data Processing** section. These prodictions are submitted as the fulfillment of this project's **"Course Project: Submission"** portion.
